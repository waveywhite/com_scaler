<?php
/**
 * Fixed version, based on the Joomla Framework String Package
 */

use Joomla\String\Inflector;

class ScalerInflector
{
	/**
	...
	*/
	...
	{
		$singular = \Joomla\String\StringHelper::strtolower($singular);
	...
	{
		$plural = \Joomla\String\StringHelper::strtolower($plural);
	...
	/**
	 * Sets an inflected word in the cache. If the singular and plural are the same the result is not cached as it is assumed
	 * that the the word was already inflected (e.g. trying to convert a plural word into a plural). If the plural is not given it
	 * is taken that the singular and the plural are identical and this is intentional.
	 *
